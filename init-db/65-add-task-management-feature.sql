-- 65-add-task-management-feature.sql
-- Add task_management feature to the features table and enable it for appropriate plans

-- Add the task_management feature if it doesn't exist
...
-- Enable task_management for appropriate plans
...
BEGIN
    ...
    -- Enable task_management for starter plan and above (not freemium)
...
DO $$
BEGIN
    RAISE NOTICE '✓ Task management feature added and enabled for starter, pro, agency, and enterprise plans';
END $$;
