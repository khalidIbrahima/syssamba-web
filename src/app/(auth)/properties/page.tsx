              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">{property.totalUnits} Lots</span>
                    <span className="text-gray-900 font-medium">{property.occupiedUnits} Occupés</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">Revenus mensuels</span>
                    <span className="text-gray-900 font-bold">{formatCurrency(property.monthlyIncome)}</span>
                  </div>
                </div>
