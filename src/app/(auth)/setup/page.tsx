        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="text-left">
              <p className="text-sm font-medium text-gray-700">Étape {currentStep} sur 3</p>
                      ...
                      >
                        ...
                        <CardContent className="p-6">
                          ...
                          <div className="space-y-2 mb-4 pb-4 border-b">
                            ...
                            <div className="flex items-center justify-between text-sm">
                              <span className="text-gray-600">Locataires extranet</span>
                              <span className="font-semibold text-gray-900">
                ...
                selectedPlan.price > 0 && (
                  <div className="space-y-3 mb-6 bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-700">
                      Prix final: <span className="font-bold text-lg text-blue-600">{displayPrice}</span>
                    </p>
                  </div>
                )}
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">Plan sélectionné</h3>
                  <p className="text-sm text-gray-700">
