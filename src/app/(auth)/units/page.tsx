...
const statusColors = {
  vacant: 'bg-gray-100 text-foreground',
    ...
    >
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Liste des lots</h1>
            <p className="text-muted-foreground mt-1">Gérez et visualisez tous vos lots immobiliers</p>
          </div>
              ...
              <div className="relative h-96 w-full rounded-lg overflow-hidden border bg-gray-100">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Sélectionnez des lots pour voir la carte</p>
