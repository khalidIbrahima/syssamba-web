    ...
    <div className="space-y-6 min-h-screen bg-background">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold text-foreground">Créer un nouveau bail</h1>
                ...
                <Card className="bg-gray-50">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Loyer mensuel total</span>
                    ...
                    <div className="flex justify-between pt-2 border-t">
                      <span className="text-muted-foreground">Premier versement</span>
                      <span className="font-bold text-foreground">
                        {firstPayment.toLocaleString('fr-FR')} FCFA
                      </span>
                    </div>
                    <p className="text-xs text-muted-foreground">(1er loyer + dépôt)</p>
                    <div className="flex justify-between pt-2 border-t">
