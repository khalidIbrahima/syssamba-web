        ...
        <CardContent className="p-4">
          ...
          {task.assignedUserName && (
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm text-muted-foreground">{task.assignedUserName}</span>
            </div>
          )}
...
export default function TasksPage() {
  ...
  // Calculate statistics - these are not hooks, so they can be after conditional returns
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-foreground">Gestion des Tâches</h1>
