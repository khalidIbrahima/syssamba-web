    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="relative pt-20 min-h-[90vh] flex flex-col bg-[#1e3a8a] overflow-hidden">
        ...
        */}
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-blue-900/85 via-blue-800/75 to-blue-900/85"></div>
        
        {/* Additional warm overlay to blend sunset with blue theme */}
        <div className="absolute inset-0 bg-gradient-to-br from-orange-900/20 via-transparent to-blue-900/40"></div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="text-white space-y-8 max-w-2xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.1] tracking-tight">
                  Gérez vos lots immobiliers <span className="text-yellow-400">en 30 secondes</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-2">
                  <Button className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold text-lg h-14 px-8 rounded-lg transition-all transform hover:scale-105 shadow-lg" asChild>
                ...
                <div className="flex flex-wrap gap-6 text-sm font-bold text-white pt-4">
                  <div className="flex items-center gap-2">
              ...
              <div className="relative w-full max-w-md mx-auto lg:ml-auto">
                <div className="bg-blue-400/30 backdrop-blur-sm border border-blue-300/30 rounded-2xl p-6 md:p-8 shadow-2xl">
                  ...
                  <div className="space-y-4">
                    {/* Step 1 */}
                    <div className="group bg-white/10 hover:bg-white/20 transition-colors rounded-xl p-4 flex gap-4 items-center border border-white/10">
                      <div className="flex-shrink-0 w-10 h-10 rounded-full bg-yellow-400 flex items-center justify-center text-gray-900 font-bold text-lg shadow-sm">
                        1
                      </div>
                      <div>
                        <h4 className="text-white font-bold text-base">Créez votre compte</h4>
                        <p className="text-white/80 text-sm">Email ou téléphone</p>
                      </div>
                    </div>
                    ...
                    <div className="group bg-white/10 hover:bg-white/20 transition-colors rounded-xl p-4 flex gap-4 items-center border border-white/10">
                      ...
                      <div>
                        <h4 className="text-white font-bold text-base">Ajoutez vos biens</h4>
                        <p className="text-white/80 text-sm">Import Excel ou saisie manuelle</p>
                      </div>
                    </div>
                    ...
                    <div className="group bg-white/10 hover:bg-white/20 transition-colors rounded-xl p-4 flex gap-4 items-center border border-white/10">
                      ...
                      <div>
                        <h4 className="text-white font-bold text-base">Gérez automatiquement</h4>
                        <p className="text-white/80 text-sm">Loyers, quittances, comptabilité</p>
                      </div>
                    </div>
                  </div>
